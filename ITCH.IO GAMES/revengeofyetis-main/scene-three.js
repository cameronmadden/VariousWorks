var SceneThree = new Phaser.Class({
    ...
    preload: function()
    {
        this.load.image('winner', 'assets/backgrounds/winnerscreennoback.png');
    ...
    {   
        ...
        titlemusic = this.sound.add('outdoormusic', {volume: 0.15});
        ...
        this.add.image(400, 400, 'winner').setScale(4/3)
            .setScrollFactor(0)
    },
